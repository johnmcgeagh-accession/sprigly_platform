-- Fix: apply Tavily query syntax rules to the research prompt.
-- Migration 0007 ran before the query-rules content was complete.
-- This UPDATE targets whichever version the resolver will actually pick
-- (highest version for this workflow/step/client_id=NULL combination).
-- Idempotent: safe to run more than once.

--> statement-breakpoint

UPDATE "prompt_templates"
SET "prompt_text" = $PROSPECT_RESEARCH_PROMPT_V3$
