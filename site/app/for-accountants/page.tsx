...
const data: SectorData = {
  ...
  pains: [
    ...
    "Management accounts commentary — what moved, why, and what to watch, drafted from the numbers and ready for partner review.",
  ...
  get: "A commentary draft in your format — what moved, why, and what to watch — ready for partner review.",
}
