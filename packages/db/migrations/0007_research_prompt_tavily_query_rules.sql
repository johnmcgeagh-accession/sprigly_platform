-- Add Tavily query syntax rules to the prospect research prompt.
-- Updates the existing version=1 row in place. Idempotent.

--> statement-breakpoint

UPDATE "prompt_templates"
SET "prompt_text" = $PROSPECT_RESEARCH_PROMPT_V2$
